...
# --- CLEAN ADD DIALOG (Lines 1197-1893) ---
$newAddDialog = @"
                    ...
                    children: [
                      ...
                      Row(mainAxisAlignment: MainAxisAlignment.end, children: [
                        ...
                        ElevatedButton(
                          ...
                          child: isLoading ? const CircularProgressIndicator() : const Text('Add Product'),
                        ),
                      ]),
                    ],
                  ),
...
# --- UPDATE CONTENT ---
# Replace the entire block from line 1197 to line 2701 (roughly)
# We will delete lines 1197 to 2701 and insert clean versions.
$start = 1196
$end = 2701
