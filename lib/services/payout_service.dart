...
class PayoutService {
  ...
  Future<void> requestPayout(String userId, double amount, String paymentDetails, 
      {PayoutType type = PayoutType.withdrawal, PayoutStatus status = PayoutStatus.pending, String userRole = 'general'}) async {
    try {
      if (type == PayoutType.withdrawal) {
        ...
        final QuerySnapshot recentPayoutsOrEmpty = await _firestore
            .collection('payouts')
